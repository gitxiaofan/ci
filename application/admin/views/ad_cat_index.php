        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="">
                        <a href="<?php echo site_url('adcat/add'); ?>" class="btn btn-primary ">添加广告</a>
                    </div>
                    <table class="table table-striped table-bordered table-hover " id="editable">
                        ...
                        <?php foreach($adcats as $adcat): ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="<?php echo site_url('adcat/mod'). '?id='. $adcat['id']; ?>" class="btn btn-info btn-sm">修改</a>
                                        <a href="<?php echo site_url('adcat/del'). '?id='. $adcat['id']; ?>" class="btn btn-danger btn-sm">删除</a>
                                    </div>
                                </td>
                            </tr>
                        <?php endforeach; ?>
