                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="<?php echo base_url() ?>/assets/admin/img/profile_small.jpg" /></span>
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><a class="J_menuItem" href="<?php echo site_url('admin/avater'); ?>">修改头像</a>
                                </li>
                    ...
                    <li>
                        <a class="J_menuItem" href="<?php echo site_url('admin/index'); ?>"><i class="fa fa-columns"></i> <span class="nav-label">管理员</span></a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="<?php echo site_url('user/index'); ?>"><i class="fa fa-columns"></i> <span class="nav-label">用户管理</span></a>
                    </li>
                    <li>
